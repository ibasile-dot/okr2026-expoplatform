...
export const okrData: OKR[] = [
  ...
  },
  {
    ...
    keyResults: [
      ...
      { id: "2-4", number: 4, description: "Time to launch for Networks customers reduced to <14 days", target: "< 14 days", status: "not-started" },
      { id: "2-5", number: 5, description: "ExpoPlatform recognised as a leader in event meeting formats", target: "Recognition", status: "not-started" },
    ],
  },
  {
    id: 3,

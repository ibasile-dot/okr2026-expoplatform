...
export const roadmapData: RoadmapItem[] = [
  ...
  { id: 5, month: "February", week: "w/c 23rd Feb", okr: 1, action: "Collect data about current time spent on above tasks using standard unit of measurement (per week, per month, etc.)", subactions: "Waiting on other dept and review with Julia", owner: "Ilaria, Susan, Julia, Olga, Bartek", defaultStatus: "Done", defaultNotes: "" },
  { id: 6, month: "February", week: "w/c 23rd Feb", okr: 1, action: "Plan for Automation Days", owner: "Olga, Susan, Bartek, Ilaria", defaultStatus: "In Progress", defaultNotes: "Bartosz and Ilaria are reviewing the automation days structure, with 1. quick wins we can solve on the days and 2. high impact automation targets that we can keep building after those days." },
  ...
  { id: 13, month: "March", week: "Late March", okr: 1, action: "Execute Automation Days - easy wins", owner: "Olga, Susan, Bartek, Ilaria, Yuriy", defaultStatus: "To Do", defaultNotes: "" },

...
export const roadmapData: RoadmapItem[] = [
  ...
  { id: 42, month: "April", week: "", okr: 1, action: "Search Atlas for website optimisation & SEO/GEO content creation. Scraping tool for mapping enhancement. CRM - to stick to the unified reporting and filters. Consider implementing alerts and reminders in PD", owner: "Maria, Choyonika, Chris", defaultStatus: "To Do", defaultNotes: "" },
